...
#SBATCH --mem=8000
#SBATCH -o ../Nx64/noisy_stdtrue/SFDTargSFDCov/log_apd_noiso/nophi_lamcorr_try1_%A_%a.o
#SBATCH -e ../Nx64/noisy_stdtrue/SFDTargSFDCov/log_apd_noiso/nophi_lamcorr_try1_%A_%a.e
