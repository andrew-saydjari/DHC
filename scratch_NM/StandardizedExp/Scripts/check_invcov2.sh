...
#julia Check_InvCov.jl "log" "apd" "noiso" "../Nx64/noisy_stdtrue/" "checks" "Diagonal" 
#julia Check_InvCov.jl "log" "apd" "noiso" "../Nx64/noisy_stdtrue/" "checks" "Full"
#julia Check_InvCov.jl "log" "apd" "noiso" "../Nx64/noisy_stdtrue/" "checks" "Diagonal+Eps" 
#julia Check_InvCov.jl "log" "apd" "noiso" "../Nx64/noisy_stdtrue/" "checks" "Full+Eps" 
