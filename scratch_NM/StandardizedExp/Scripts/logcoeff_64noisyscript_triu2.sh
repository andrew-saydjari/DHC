...
#SBATCH --mem=8000
#SBATCH -o ../Nx64/noisy_stdtrue/SFDTargSFDCov/reg_apd_noiso/LogCoeff/%a_1-0_triu_full_%A.o
#SBATCH -e ../Nx64/noisy_stdtrue/SFDTargSFDCov/reg_apd_noiso/LogCoeff/%a_1-0_triu_full_%A.e
