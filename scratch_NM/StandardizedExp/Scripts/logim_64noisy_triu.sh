...
#SBATCH -p shared
#SBATCH -n 5 # Number of cores/tasks
#SBATCH -N 1       # Ensures that all cores are on one Node
#SBATCH -t 0-00:20:00 # Runtime in D-HH:MM:SS
#SBATCH --mem=8000
#SBATCH -o ../Nx64/noisy_stdtrue/SFDTargSFDCov/log_apd_noiso/%a_triu_%A.o
#SBATCH -e ../Nx64/noisy_stdtrue/SFDTargSFDCov/log_apd_noiso/%a_triu_%A.e
